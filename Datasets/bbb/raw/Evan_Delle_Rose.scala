...
object Main {
  ...
  def updatePin(machineId: Int, machinePins: Array[String]): Unit = {
    ...
    machinePins(machineId) = nouveauPIN.toString

  }


  def restockMachine(machineId: Int, coffeeStocks: Array[Int], sugarStocks: Array[Int], milkStocks: Array[Int], machinePins: Array[String]): Unit = {
    ...
    coffeeStocks(machineId) += ajoutpoudreacafe
    ...
    milkStocks(machineId) += ajoutlaitenml
  ...
  def serveClient(machineId: Int, coffeeStocks: Array[Int], sugarStocks: Array[Int], milkStocks: Array[Int]): Boolean = {
    ...
    while (transactionterminee == false) {
      ...
      while ((retouraumenu == false) && (transactionterminee == false)) {
        ...
        if (choixducafe == 1) {
          ...
          if ((choixdusucre == 2) && (sugarStocks(machineId) < 5)) {
            println("Boisson sélectionnée : " + cafechoisi)
            println("Niveau de sucre : " + sucrechoisi)
          ...
          if ((choixdusucre == 3) && (sugarStocks(machineId) < 10)) {
            println("Boisson sélectionnée : " + cafechoisi)
            println("Niveau de sucre : " + sucrechoisi)
            println("Erreur : stock de sucre insuffisant. ")
            println("Veuillez sélectionner une autre machine.")
          ...
          if ((choixdusucre == 4) && (sugarStocks(machineId) < 15)) {
            println("Boisson sélectionnée : " + cafechoisi)
            println("Niveau de sucre : " + sucrechoisi)
            println("Erreur : stock de sucre insuffisant. ")
            println("Veuillez sélectionner une autre machine.")
        ...
        if (choixducafe == 2) {
          ...
          if ((choixnbdosedelait == 1) && (milkStocks(machineId) < 50)) {
            println("Boisson sélectionnée : " + cafechoisi)
            println("Niveau de sucre : " + sucrechoisi)
            println("Lait en supplément : " + laitensupplement)
            println("")
            ...
            println("Veuillez sélectionner une autre machine.")
            milkStocks(machineId) += 100 //rajout du stock de lait enlevé plus haut car boisson non préparable avec suppléement lait

            retouraumenu = true
            return false
          }
          if ((choixnbdosedelait == 2) && (milkStocks(machineId) < 100)) {
            println("Boisson sélectionnée : " + cafechoisi)
            println("Niveau de sucre : " + sucrechoisi)
            println("Lait en supplément : " + laitensupplement)
            println("")
          ...
          if ((choixnbdosedelait == 3) && (milkStocks(machineId) < 150)) {
            println("Boisson sélectionnée : " + cafechoisi)
            println("Niveau de sucre : " + sucrechoisi)
            println("Lait en supplément : " + laitensupplement)
            println("")
        ...
        if (choixducafe == 3) {
          ...
          if ((choixtaillelatte == 1) && (coffeeStocks(machineId) < 6)) {
            println("Boisson sélectionnée : " + cafechoisi)
            println("Niveau de sucre : " + sucrechoisi)
            println("Lait en supplément : " + laitensupplement)
            println("")
          ...
          if ((choixtaillelatte == 1) && (milkStocks(machineId) < 120)) {
            println("Boisson sélectionnée : " + cafechoisi)
            println("Niveau de sucre : " + sucrechoisi)
            println("Lait en supplément : " + laitensupplement)
            println("")
          ...
          if ((choixtaillelatte == 2) && (coffeeStocks(machineId) < 8)) {
            println("Boisson sélectionnée : " + cafechoisi)
            println("Niveau de sucre : " + sucrechoisi)
            println("Lait en supplément : " + laitensupplement)
            println("")
          ...
          if ((choixtaillelatte == 2) && (milkStocks(machineId) < 150)) {
            println("Boisson sélectionnée : " + cafechoisi)
            println("Niveau de sucre : " + sucrechoisi)
            println("Lait en supplément : " + laitensupplement)
            println("")
          ...
          if ((choixtaillelatte == 3) && (coffeeStocks(machineId) < 12)) {
            println("Boisson sélectionnée : " + cafechoisi)
            println("Niveau de sucre : " + sucrechoisi)
            println("Lait en supplément : " + laitensupplement)
            println("")
          ...
          if ((choixtaillelatte == 3) && (milkStocks(machineId) < 200)) {
            println("Boisson sélectionnée : " + cafechoisi)
            println("Niveau de sucre : " + sucrechoisi)
            println("Lait en supplément : " + laitensupplement)
            println("")
          ...
          if ((choixnbdosedelait == 1) && (milkStocks(machineId) < 50)) {
            ...
            println("Erreur : stock de lait insuffisant. ")
            println("Veuillez sélectionner une autre machine.")
            if(choixtaillelatte == 1) {milkStocks(machineId) += 120} //rajout du stock de lait enlevé plus haut car boisson non préparable avec suppléement lait
            if(choixtaillelatte == 2) {milkStocks(machineId) += 150} //rajout du stock de lait enlevé plus haut car boisson non préparable avec suppléement lait
            if(choixtaillelatte == 3) {milkStocks(machineId) += 200} //rajout du stock de lait enlevé plus haut car boisson non préparable avec suppléement lait
            retouraumenu = true
            return false
          }
    ...
    def main(args: Array[String]): Unit = {
      ...
      var machinePins = Array.fill(nbmachine)(initialpin)


      //gestion du stock
      var coffeeStocks = Array.fill(nbmachine)(50) //grammes
      var sugarStocks = Array.fill(nbmachine)(30) // grammes
      var milkStocks = Array.fill(nbmachine)(500) // ml mais afficher en litres
      ...
      while (quitter == false) {
        ...
        if (quitter == false) {
          ...
          while ((machineId != 1) && (machineId != 2) && (machineId != 3) && (machineId != 4) && (machineId != 5)) {
            println("Entrée invalide, veuillez entrer une valeur entre 1 et 5")
            machineId = readInt()
          }
          if (machineId == 1) {
            machineId = 0
          ...
          if (choixdumode == 1) {
            while (serveClient(machineId, coffeeStocks, sugarStocks, milkStocks) == false) {
              machineId = readInt()
              while ((machineId != 1) && (machineId != 2) && (machineId != 3) && (machineId != 4) && (machineId != 5)) {
                println("Entrée invalide, veuillez entrer une valeur entre 1 et 5")
                machineId = readInt()
          ...
          if (choixdumode == 2) {
            if (validatePin(machineId, machinePins) == true) {
              ...
              if (choixdelaction == 2) {
                restockMachine(machineId, coffeeStocks, sugarStocks, milkStocks, machinePins)
              }
            }
            else {
              quitter = true
